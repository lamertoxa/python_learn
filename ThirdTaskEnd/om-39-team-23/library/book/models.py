...
class Book(models.Model):
    ...
    year_of_publication = models.DateTimeField(null=True, blank=True, editable=True, default=timezone.now)
    date_of_issue  = models.DateTimeField(default=timezone.now, editable=True,null=True, blank=True)
