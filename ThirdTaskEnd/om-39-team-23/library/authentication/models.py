...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    email = models.CharField(max_length=100, unique=True, default=None, blank=True, null=True)
    ...
    role = models.IntegerField(choices=ROLE_CHOICES, default=0,editable=True)
